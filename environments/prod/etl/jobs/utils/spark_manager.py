...
from environments.prod.etl.jobs.utils.terraform_config import (
...
class SparkSessionManager:
    ...
    @classmethod
    def get_session(cls, app_name: str = "NYC Taxi ETL") -> SparkSession:
        """
        ...
        if cls._instance is None:
            try:
                ...
                builder = (
                    ...
                    .config(
                        "spark.hadoop.fs.gs.max.wait.for.empty.object.creation", "60000"
                    )
                    .config(
                        "spark.jars.packages",
