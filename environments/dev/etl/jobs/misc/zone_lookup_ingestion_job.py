...
This module implements the misc layer pipeline for NYC Taxi zone lookup reference data.
...
class ZoneLookupIngestionJob(BaseSparkJob):
    """
    Production-ready misc layer job for NYC Taxi zone lookup reference data.
    ...
    def __init__(self, config: Optional[JobConfig] = None):
        """
        Initialise the zone lookup misc layer job.
